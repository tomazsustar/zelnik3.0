 ...
 */
class VsebineViewArticle extends JViewLegacy
...
//		$results = $dispatcher->trigger('onContentPrepare', array ('com_vsebine.prispevek', &$item, &$this->params));
//
//		$item->event = new stdClass;
//		$results = $dispatcher->trigger('onContentAfterTitle', array('com_vsebine.prispevek', &$item, &$this->params));
//		$item->event->afterDisplayTitle = trim(implode("\n", $results));
//
//		$results = $dispatcher->trigger('onContentBeforeDisplay', array('com_vsebine.prispevek', &$item, &$this->params));
//		$item->event->beforeDisplayContent = trim(implode("\n", $results));
//
//		$results = $dispatcher->trigger('onContentAfterDisplay', array('com_vsebine.prispevek', &$item, &$this->params));
