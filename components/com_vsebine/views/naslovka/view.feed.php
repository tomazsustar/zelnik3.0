 ...
 * @since       1.5
 */
class VsebineViewNaslovka extends JViewLegacy
{
	public function display($tpl = null)
	{
		...
		foreach ($rows as $row)
		{
			...
			$description = ($params->get('feed_summary', 0) ? $row->introtext.$row->fulltext : "<img src='".$row->slika."' style='vertical-align:bottom; max-height:100px; margin-right:20px; width:auto;' alt='slika vsebine'>".$row->introtext);
